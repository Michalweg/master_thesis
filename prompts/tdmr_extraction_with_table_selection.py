...
```json
{"explanation": "A reasoning behind choosing a table to be used to extract result for a given triplet.", "table_id_to_extract_result_metric_from": 0}
```
"""
...
Return the output in the form of a JSON file, you MUST follow following structure: 

```json
{
  "explanation": "A reasoning behind choosing a table to be used to extract result for a given triplet.",
  "table_id_to_extract_result_metric_from": "A table id (in the from of an integer) which should be used to extract result for a given triplet."
}
'''
"""
